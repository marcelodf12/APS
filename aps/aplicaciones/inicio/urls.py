...
from aps.aplicaciones.inicio.views import listarUsuarios,asignarGrupo, listarUsuriosDeGrupo
urlpatterns = patterns('',
    ...
    url(r'^Grupos/listarUsuarios/(?P<id>[\w]+)$', listarUsuriosDeGrupo.as_view(), name='listar_usuarios_de_grupo'),
)